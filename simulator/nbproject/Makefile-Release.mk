...
${TESTDIR}/tests/CellTest.o: tests/CellTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CellTest.o tests/CellTest.cpp


${TESTDIR}/tests/MarkerTest.o: tests/MarkerTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/MarkerTest.o tests/MarkerTest.cpp
...
${TESTDIR}/tests/instrtest.o: tests/instrtest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/instrtest.o tests/instrtest.cpp
...
${TESTDIR}/tests/programtest.o: tests/programtest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/programtest.o tests/programtest.cpp
...
${OBJECTDIR}/instruction_nomain.o: ${OBJECTDIR}/instruction.o instruction.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/instruction_nomain.o instruction.cpp;\
	else  \
