...
${OBJECTDIR}/_ext/b6201e23/Bug.o: ../../Documents/phase2/Simulator/Bug.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b6201e23/Bug.o ../../Documents/phase2/Simulator/Bug.cpp

${OBJECTDIR}/_ext/b6201e23/Cell.o: ../../Documents/phase2/Simulator/Cell.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/b6201e23
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b6201e23/Cell.o ../../Documents/phase2/Simulator/Cell.cpp

${OBJECTDIR}/_ext/b6201e23/Marker.o: ../../Documents/phase2/Simulator/Marker.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/b6201e23
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b6201e23/Marker.o ../../Documents/phase2/Simulator/Marker.cpp

${OBJECTDIR}/_ext/b6201e23/World.o: ../../Documents/phase2/Simulator/World.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/b6201e23
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b6201e23/World.o ../../Documents/phase2/Simulator/World.cpp
...
${TESTDIR}/tests/newtestclass2.o: tests/newtestclass2.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newtestclass2.o tests/newtestclass2.cpp
...
${TESTDIR}/tests/newtestclass3.o: tests/newtestclass3.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newtestclass3.o tests/newtestclass3.cpp


${TESTDIR}/tests/newtestrunner3.o: tests/newtestrunner3.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/newtestrunner3.o tests/newtestrunner3.cpp
...
${OBJECTDIR}/_ext/b6201e23/Bug_nomain.o: ${OBJECTDIR}/_ext/b6201e23/Bug.o ../../Documents/phase2/Simulator/Bug.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b6201e23/Bug_nomain.o ../../Documents/phase2/Simulator/Bug.cpp;\
	else  \
...
${OBJECTDIR}/_ext/b6201e23/Cell_nomain.o: ${OBJECTDIR}/_ext/b6201e23/Cell.o ../../Documents/phase2/Simulator/Cell.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b6201e23/Cell_nomain.o ../../Documents/phase2/Simulator/Cell.cpp;\
	else  \
...
${OBJECTDIR}/_ext/b6201e23/Marker_nomain.o: ${OBJECTDIR}/_ext/b6201e23/Marker.o ../../Documents/phase2/Simulator/Marker.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b6201e23/Marker_nomain.o ../../Documents/phase2/Simulator/Marker.cpp;\
	else  \
...
${OBJECTDIR}/_ext/b6201e23/World_nomain.o: ${OBJECTDIR}/_ext/b6201e23/World.o ../../Documents/phase2/Simulator/World.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/b6201e23/World_nomain.o ../../Documents/phase2/Simulator/World.cpp;\
	else  \
